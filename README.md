...
JS Package : GSAP write animations in much easier fashion compared to css and vanilla JS and 
it allows to do much complex things like easyings and chaining together multiple animations 
...
3. whenever you don't have an internet activated it still allows to cache the webpage or 
   your website or app and still you use it offline
